...
/**
 * @file
 *   This file defines String class for framework
 */
...
namespace mpp {
/**
 * @addtogroup base-string
 *
 * @brief
 *   This module includes String class definitions.
 * 
 * @note Taked from OpenThread project (https://github.com/openthread/openthread/blob/main/src/core/common/string.hpp).
 *
 * @{
 *
 */
